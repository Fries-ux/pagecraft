    ...
    <div style={{ minHeight: "100vh", background: "#f5f2ec", fontFamily: "'Georgia', 'Times New Roman', serif", color: "#1a1a1a" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .generate-btn:hover { background: #1a1a1a !important; }
        .tab-btn:hover { color: #8a7a5a !important; }
        input:focus, textarea:focus, select:focus { border-color: #8a7a5a !important; box-shadow: 0 0 0 3px rgba(138,122,90,0.12) !important; }
        .copy-btn:hover { background: #1a1a1a !important; color: #f5f2ec !important; }
        .section-divider { border: none; border-top: 1px solid #ddd6c8; margin: 0; }
        ::-webkit-scrollbar { width: 6px; }
        ::-webkit-scrollbar-track { background: #f5f2ec; }
        ::-webkit-scrollbar-thumb { background: #d0c9bc; border-radius: 3px; }
